...
-- left join con alias en las tablas
select c.nombre, c.apellido, ord.id_orden, ord.fecha_orden
from clientes c
left join ordenes ord on c.idcliente = ord.idcliente
order by fecha_orden;

-- right join, solo me trae los clientes que hicieron ordenes
...
--full join: todas las filas, sin importar si no coinciden, puede haber nulls en ambos lados.
select ordenes.id_orden, clientes.nombre, clientes.apellido, clientes.ciudad, clientes.direccion, ordenes.fecha_orden
from clientes
